...
-- Updated three test scores for the three students
UPDATE student_exam
    SET score = '924'
    WHERE student_id = '46';
...
-- Selecting data
/* Display exam name, average score, and number of attempts.
Only include attempts starting from the beginning of 2006.
Display the exam with the most number of attempts first.
*/
...
/*Display student name and number of school applications that
were accepted. Display the name is "last,first" format. 
Only current 8th graders with two or fewer acceptances should
be shown. Order students with most acceptances first. 
Students with same number of acceptances should be ordered by
A-Z last name then first name.
*/
...
/*Display each stundent's first name, last name, and college they
are attendeing. Only include students who have graduated since 2006
and are attending a college in Georgia. Order by college name, 
student last name, and then student first name.
*/
...
/*Display student first name, last name, volunteer work description,
and number of days worked on project. Include students that worked
on their project 30-90 days and are in the 5th grade. Display
students who worked the longest first.
*/
...
/*Display a list of all current student and their foster
mothers or fathers who do not live in the same city.
Display names in "last, first" format. Order by student
last name then first name A-Z.
*/
...
/*Display each student's grade level, last name, first name,
and phone number. Sort by grade level, last name, and then 
first name.
*/
...
/*Display number of students currently enrolled for each grade level
in grade-level order.
*/
